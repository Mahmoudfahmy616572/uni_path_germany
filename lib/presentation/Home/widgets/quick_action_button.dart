      ...
      children: [
        ...
        Container(
          ...
          child: Material(
            ...
            clipBehavior: Clip.antiAlias, // بيقص الموجة عشان ماتخرجش برا الدايرة
            child: InkWell(
              onTap: () {
              ...
              splashColor: const Color(0xFF5A67D8).withOpacity(0.2), // لون الموجة
              highlightColor: const Color(0xFF5A67D8).withOpacity(0.1), // لون الهالة وقت اللمس
              child: SizedBox(
                width: 60,
                height: 60,
