...
class UserModel extends UserEntity {
  UserModel({
    ...
    required super.gpa,
    required super.academicAverage,
    required super.highSchoolScore,
    required super.maxGpa,
    required super.minGpa,
    required super.hasIelts,
    required super.ieltsScore,
    required super.hasToefl,
    required super.toeflScore,
    required super.hasMoi,
    required super.nationality,
    required super.preferredCities,
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    ...
    return UserModel(
      ...
      hasToefl: json['has_toefl'] as bool? ?? false,
      toeflScore: (json['toefl_score'] as num?)?.toDouble() ?? 0.0,
      hasMoi: json['has_moi'] as bool? ?? false,
      nationality: json['nationality']?.toString() ?? '',
      preferredCities: List<String>.from(json['preferred_cities'] ?? []),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'has_toefl': hasToefl,
      'toefl_score': hasToefl ? toeflScore : 0.0,
      'has_moi': hasMoi,
